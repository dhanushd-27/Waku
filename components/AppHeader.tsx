...
export const AppHeader: React.FC = () => {
  return (
    <header className="w-full flex items-center justify-between rounded-full border border-accent-200/30 bg-white px-10 py-3 shadow-sm">
      <h1 className="text-xl font-semibold text-background-dark">Waku</h1>
      <div className="flex items-center gap-2">
        <div className="relative group">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center justify-center w-8 h-8 rounded-full border border-accent-200/60 bg-white text-background-dark transition hover:border-background-dark hover:bg-accent-900"
          ...
          >
            <svg
              ...
              focusable="false"
              viewBox="0 0 24 24"
              className="h-4 w-4 fill-background-dark"
            >
          ...
          <div className="absolute right-0 top-full mt-2 px-3 py-2 text-xs text-white bg-background-dark rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none whitespace-nowrap">
            View on GitHub
            <div className="absolute -top-1 right-4 w-2 h-2 bg-background-dark rotate-45"></div>
          </div>
        </div>
        <div className="relative group">
          <button
          ...
          <div className="absolute right-0 top-full mt-2 w-64 px-3 py-2 text-xs text-white bg-background-dark rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none">
