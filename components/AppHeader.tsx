    ...
    <header className="w-full flex items-center justify-between rounded-full border px-10 py-3 shadow-sm bg-[color:var(--color-panel-bg)] border-[color:var(--color-border-muted)]">
      ...
      <div className="flex items-center gap-2">
        <div className="relative group">
          ...
          <div className="tooltip-surface absolute right-0 top-full mt-2 px-3 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none whitespace-nowrap">
            View on GitHub
            <div className="absolute -top-1 right-4 w-2 h-2 rotate-45 bg-[color:var(--color-primary-black)]"></div>
          </div>
        </div>
        <div className="relative group">
          <button
          ...
          <div className="tooltip-surface absolute right-0 top-full mt-2 w-64 px-3 py-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50 pointer-events-none">
