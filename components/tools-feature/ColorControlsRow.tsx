      ...
      <div className="flex flex-1 items-center gap-2">
        <div className="relative flex-1 group">
          ...
          <button
            type="button"
            onClick={onCopy}
            className="absolute inset-y-0 right-2 my-auto inline-flex h-5 w-5 items-center justify-center rounded opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100 focus-visible:opacity-100 focus:outline-none text-[color:var(--color-brand-orange)]"
